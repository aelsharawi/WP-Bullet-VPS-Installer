...
install_dotdeb
debconf-apt-progress -- apt-get update
debconf-apt-progress -- apt-get install libmemcached* memcached libanyevent-perl libyaml-perl libterm-readkey-perl libevent-dev libsasl2-2 sasl2-bin libsasl2-2 libsasl2-dev php5-dev php5-json php5-igbinary php5-msgpack pkg-config libtool-bin build-essential -y
